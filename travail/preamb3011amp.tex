% Cette version (non publicisée) du préambule INU3011 permet d'utiliser des tableaux en LaTeX,
% en laissant l'esperluette active. À mentionner seulement aux étudiants qui explorent LaTeX par
% eux-mêmes et veulent utiliser les tableaux.
