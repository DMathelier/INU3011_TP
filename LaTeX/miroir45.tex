     ...
     \input{../travail/preamb3011}  {\bf \huge Code d’identification : miroir45} \\
    \newline \hr \begin{center} \image{../photos/miroir45.jpg} \end{center} 
   ...
   \section* {Origine} 
    ...
    {\bf \large Moyen d’acquisition :} achat \\ \\
     {\bf \large Prix d’achat :} 3500 €  \end{document} 