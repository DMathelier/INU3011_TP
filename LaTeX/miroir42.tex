    ...
    \input{../travail/preamb3011}  {\bf \huge Code d’identification : miroir42} \\
    ...
    \\ \\ {\bf \large Style :} ce miroir rectangulaire comporte un trumeau imitant les
            pratiques de décoration qui ont eu cours à partir du règne de Louis XVI et se sont poursuivies au XIX\up{e} siècle. La pièce imitant le bois sculpté est soulignée d'une
   ...
   \section* {Origine} 
    ...
    En février 2021, le prix du miroir était estimé à 715 €. \section* {Usage attendu}
     Ce miroir à fixer convient particulièrement à un salon, ou bien à une chambre, une entrée
            pour la vérification de l'habillement de pied en cap. Selon le vendeur, il est \em{idéal pour un salon ou même un dressing}  \end{document} 